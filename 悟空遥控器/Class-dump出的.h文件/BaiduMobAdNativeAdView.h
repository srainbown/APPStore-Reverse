...
@class BaiduMobAdImageDownloadQueue, BaiduMobAdNativeAdObject, BaiduMobAdNativeVideoBaseView, BaiduMobAdNativeWebView, BaiduMobAdRendererHelper, BaiduMobAdSpamViewValidator, NSString, UIImageView, UILabel, UITapGestureRecognizer, UIViewController;

@interface BaiduMobAdNativeAdView : UIView <BaiduMobAdActionComposerDelegate>
{
