...
@class MiPushASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL;

@interface MiPushASIHTTPRequest : NSOperation <NSCopying>
{
    NSURL *url;
    NSURL *originalURL;
    NSURL *redirectURL;
    id <MiPushASIHTTPRequestDelegate> delegate;
    id <MiPushASIHTTPRequestDelegate><MiPushASIProgressDelegate> queue;
    ...
    id <MiPushASIProgressDelegate> uploadProgressDelegate;
    id <MiPushASIProgressDelegate> downloadProgressDelegate;
    ...
    MiPushASIHTTPRequest *mainRequest;
    ...
    NSTimer *statusTimer;
    id <MiPushASICacheDelegate> downloadCache;
    int cachePolicy;
    ...
    MiPushASIDataDecompressor *dataDecompressor;
    _Bool shouldWaitToInflateCompressedResponses;
    _Bool isPACFileRequest;
    MiPushASIHTTPRequest *PACFileRequest;
...
+ (void)performInvocation:(id)arg1 onTarget:(id *)arg2 releMiPushASIngObject:(id)arg3;
...
@property(retain, nonatomic) MiPushASIHTTPRequest *PACFileRequest; // @synthesize PACFileRequest;
...
@property(retain) MiPushASIDataDecompressor *dataDecompressor; // @synthesize dataDecompressor;
- (void)dealloc;
...
@property id <MiPushASICacheDelegate> downloadCache; // @synthesize downloadCache;
...
- (void)main;
@property MiPushASIHTTPRequest *mainRequest; // @synthesize mainRequest;
- (void)markAsFinished;
