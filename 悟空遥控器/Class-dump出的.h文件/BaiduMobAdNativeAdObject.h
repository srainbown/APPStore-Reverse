...
@class BaiduMobAdInstance, BaiduMobAdNativeAdView, NSArray, NSNumber, NSString;
...
@interface BaiduMobAdNativeAdObject : NSObject
{
    ...
    NSString *_text;
    NSString *_title;
    BaiduMobAdNativeAdView *_associatedView;
    NSArray *_morepics;
    double _adStartTime;
...
@property(nonatomic) __weak BaiduMobAdNativeAdView *associatedView; // @synthesize associatedView=_associatedView;
