...
@class NSMutableDictionary, NSString, UMSocialComFMDatabase, UMSocialComFMStatement;

@interface UMSocialComFMResultSet : NSObject
{
    UMSocialComFMDatabase *_parentDB;
    UMSocialComFMStatement *_statement;
    NSString *_query;
...
@property(retain) UMSocialComFMStatement *statement; // @synthesize statement=_statement;
