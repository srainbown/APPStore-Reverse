...
@class NSString, Target, XmPushActionUnSubscription;

@interface XmPushActionUnSubscriptionResult : NSObject <NSCoding>
{
    NSString *__debug;
    Target *__target;
    NSString *__id;
    NSString *__appId;
    XmPushActionUnSubscription *__request;
...
- (_Bool)reasonIsSet;
@property(retain, nonatomic, getter=request, setter=setRequest:) XmPushActionUnSubscription *request;
- (_Bool)requestIsSet;
