...
#import "MiPushASIHTTPRequestDelegate.h"
#import "MiPushASIProgressDelegate.h"
#import "NSCopying.h"

@class NSDictionary, NSString;

@interface MiPushASINetworkQueue : NSOperationQueue <MiPushASIProgressDelegate, MiPushASIHTTPRequestDelegate, NSCopying>
{
    id delegate;
